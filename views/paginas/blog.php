<main class="contenedor seccion">
        ...
        <article class="entrada-blog">
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="/entrada">
                        <h4>Guia para tener ordenada tu casa</h4>
                        <p>Escrito el: <span>02/07/2021</span> por: <span>Facundo Scardillo</span></p>
                        <p>Maximiza el espacio en tu hogar con esta guia, aprende a combinar muebles y colores para darle vida a tu espacio</p>
                    </a>
                </div>
            ...
            <article class="entrada-blog">
                ...
                <div class="texto-entrada">
                    <a href="/entrada">
                        <h4>Retro iluminación para tu cuarto</h4>
                        <p>Escrito el: <span>02/07/2021</span> por: <span>Facundo Scardillo</span></p>
                        <p>Optimiza la iluminación de tu cuarto, ya sea de fuentes naturales o artificiales, con el objetivo de lograr una mayor calidad visual</p>
                    </a>
                </div>
